...
pub const STATIONS: &[Station] = &[
    ...
    Station {
        ...
        utc_offset_hours: 9,
        tz: "Asia/Tokyo",
        sigma: [1.132, 1.132, 1.365],
        bias: [1.158, 1.158, 0.989],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    // International WU/METAR cities (all °C display), fitted the same way; truth re-verified 5/5
    // against settled captures. Seoul's sigma is honestly WIDE: Incheon airport is a reclaimed
    // island and the forecast grid cell is mostly sea — it will rarely clear an edge threshold.
    // k0 for UTC+8/+9 cities is a nearly/fully elapsed local day at capture (hence tiny/filled-in
    // sigma); Tokyo- and Seoul-style +9 rows reuse k1 for the unreachable k0 slot.
    Station {
        city: "Toronto",
        iem_id: "CYYZ",
        ...
        utc_offset_hours: -5,
        tz: "America/Toronto",
        sigma: [1.445, 1.814, 2.053],
        bias: [0.736, 1.084, 0.714],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        sigma: [1.44, 1.574, 1.689],
        bias: [0.544, 0.697, 0.669],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: 8,
        tz: "Asia/Shanghai",
        sigma: [0.3, 1.547, 1.807],
        bias: [-0.007, 0.577, 0.694],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: 8,
        tz: "Asia/Shanghai",
        sigma: [0.3, 2.011, 2.403],
        bias: [-0.034, 0.72, 0.41],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: 1,
        tz: "Europe/Madrid",
        sigma: [0.831, 1.276, 1.385],
        bias: [-0.131, 0.16, 0.192],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        sigma: [1.164, 1.164, 1.249],
        bias: [0.254, 0.254, 0.156],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: -5,
        tz: "America/Panama",
        sigma: [1.258, 1.258, 1.284],
        bias: [0.877, 0.877, 0.918],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: 9,
        tz: "Asia/Seoul",
        sigma: [3.412, 3.412, 3.301],
        bias: [2.795, 2.795, 2.842],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        sigma: [1.752, 1.839, 2.08],
        bias: [1.169, 1.237, 1.318],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: 8,
        tz: "Asia/Shanghai",
        sigma: [0.3, 1.551, 1.666],
        bias: [0.0, -0.425, -0.434],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: 8,
        tz: "Asia/Singapore",
        sigma: [0.3, 1.279, 1.444],
        bias: [0.0, 0.865, 0.927],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
    ...
    Station {
        ...
        utc_offset_hours: 8,
        tz: "Asia/Shanghai",
        sigma: [0.3, 1.632, 1.615],
        bias: [0.0, 1.198, 1.255],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: 8,
        tz: "Asia/Manila",
        sigma: [0.3, 1.305, 1.471],
        bias: [0.0, 0.136, 0.248],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
    Station {
        ...
        utc_offset_hours: 1,
        tz: "Europe/Paris",
        sigma: [0.557, 0.885, 1.221],
        bias: [-0.218, 0.125, 0.84],
        post_bias: 0.0,
        post_sigma: 0.10,
    },
];
